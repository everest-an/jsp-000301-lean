/-
  JSP-000301 (The Justin Sun Prize problem bank)
  https://github.com/TheJustinSunPrize/awards/blob/main/problems/catalog-0301-0400.md#JSP-000301

  Problem (catalog): "If two consecutive positive integers are powerful,
  must at least one be a perfect square?"

  Resolution recorded by the bank: NO — Solomon W. Golomb gave a counterexample
  in 1970 ("Powerful numbers", Amer. Math. Monthly 77(8), 848-852).

  The counterexample formalised here is the standard minimal one:
      12167 = 23^3
      12168 = 2^3 * 3^2 * 13^2 = 12167 + 1
  Both are powerful; neither is a perfect square.

  Definitions used (standard):
    Powerful n  := every prime p dividing n has p^2 | n
